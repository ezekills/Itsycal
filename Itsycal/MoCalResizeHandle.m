    ...
    if (self) {
        ...
        _dot = [NSImage imageWithSize:dotRect.size flipped:NO drawingHandler:^BOOL(NSRect dstRect) {
            NSGradient *g = [[NSGradient alloc] initWithColors:@[
                [NSColor colorWithHue:0 saturation:0 brightness:0.9 alpha:1],
                [NSColor colorWithHue:0 saturation:0 brightness:1 alpha:1]]];
...
{
    [[NSColor colorWithHue:0.585 saturation:0.18 brightness:0.3 alpha:1] set]; //***
